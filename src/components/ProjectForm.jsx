      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500 mt-1">
            KLOC = Miles de líneas de código (1 KLOC = 1000 líneas)
          </p>
        </div>
      ...
      {result && (
        <div className="mt-8 bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 border border-green-200">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-bold text-gray-800 mb-2">Resultados de la Estimación</h3>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
              ...
              <div className="text-center">
                ...
                <p className="text-3xl font-bold text-gray-800">{result.esfuerzo.toFixed(2)}</p>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
              ...
              <div className="text-center">
                ...
                <p className="text-3xl font-bold text-gray-800">{result.duracion.toFixed(2)}</p>
