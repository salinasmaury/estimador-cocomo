  ...
  <nav className="flex justify-center items-center py-4 px-8">
    <div className="flex gap-4 items-center flex-col w-full">
      <div className="flex items-center gap-2 text-gray-300 mr-8">
        ...
        <div className="font-medium">Modelos COCOMO:</div>
      </div>

      <Link
        to="/basico"
        className="group relative px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 rounded-lg shadow-lg transform hover:scale-105 transition-all duration-300 ease-in-out m-1"
      >
